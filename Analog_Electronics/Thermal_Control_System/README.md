...
##  Arquitetura do Sistema e Estrutura de Pastas

O projeto está dividido em dois diretórios principais que refletem os blocos lógicos do sistema:
...
### 📁 [2_Control_and_Actuation](./2_Control_and_Actuation)
Este módulo contém as malhas de controlo concebidas para atuar fisicamente sobre a carga, interpretando o sinal condicionado.
...
* **Software & Código:** C/C++, LabVIEW, Microsoft Excel (para análise de regressões e validação estatística).
