...
Este repositório contém o firmware desenvolvido para o microcontrolador ATmega128 (arquitetura AVR) no âmbito da cadeira de Microcontroladores e Microprocessadores (MICMIC), focado na interação direta com periféricos físicos e no controlo de potência. O repositório está dividido em dois projetos principais que exploram desde operações de I/O a baixo nível até ao controlo de sistemas eletromecânicos através de protocolos de comunicação e processamento de sinais.
...
## Projeto 1: Lógica de Automação e I/O (Assembly)
...
## Projeto 2: Controlo de Motores e Comunicações (C & Assembly)
