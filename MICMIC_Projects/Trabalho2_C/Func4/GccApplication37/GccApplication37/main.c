...
void AtualizarDisplays(unsigned char value, signed char posicao_atual); // Atualizar Displays
...
void AtualizarDisplays(unsigned char value, signed char pos_atual)
{
	contador3++;
	if (contador3 > 3)
	{
